...
public class CategoryDAO {
  ...
  public Category getCategoryById(int id) {
    String query =
        "select " +
            "category.object_id category_id, category_attr.value name_category " +
            "from " +
            "objects category, attributes category_attr " +
            "where " +
            "category.object_id = ? and " +
            "category.object_id = category_attr.object_id and " +
            "category_attr.attr_id = 14 /*14 is attr_id of \"name_category\"*/";
  ...
  public void deleteCategoryById(int id) {
    String query =
        "delete from " +
            ...
            "where " +
            "category.object_id = ? and " +
            "category.object_type_id = 8 /*8 object_type of \"category\"*/";
  ...
  public Category updateCategory(Category category) {
    String queryUpdateAttributes =
        "update " +
            ...
            "where " +
            "category.object_id = ? and " +
            "category.attr_id = 14 /*14 is attr_id of \"name_category\"*/";
  ...
  public int createCategory(Category newCategory) {
    String queryInsert =
        "insert all " +
            ...
            "values (object_id_pr.nextval, 8 , 'Category ' || object_id_pr.currval) /*8 object_type of \"category\"*/" +
            "into " +
            "attributes(attr_id, object_id, value) " +
            "values (14, object_id_pr.currval, ?) /*14 is attr_id of \"name_category\"*/" +
            "select * from dual";
